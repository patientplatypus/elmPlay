              ...
              , div
                ...
                ,div
                  ...
                  [
                    ...
                    [class "PageHeading redBack blackColor"]
                    [
                      p[][text "Ports in and out of Vue"]
                    ]
                    ,div
                    [class "PageText blackBack whiteColor"
                    , style[("position", "relative")]]
...
socketHandler : Model.Model -> Html Update.Msg
socketHandler model =
...
portHandler : Model.Model ->  Html Update.Msg
portHandler model =
  if model.jsTime == "" then
    div
      []
      [
        button [onClick RetrievejsTime] [text "Get Time from Vue!"]
      ]
  else
    div
      []
